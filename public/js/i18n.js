...
const STRINGS = {
  ...
  // Asking for money back. Giving up the spot is part of it \u2014 the place
  // goes to the waitlist the moment they ask, not when an exec gets round to it.
  askRefund: ['Request a refund', 'Demander un remboursement'],
  askRefundConfirm: ['Give up your spot on {list} and ask for your {amount} back? The place goes to the waitlist straight away, and an exec will sort the money out with you.',
                     'Lib\u00e9rer votre place sur {list} et demander vos {amount}? La place passe imm\u00e9diatement \u00e0 la liste d\u2019attente, et un exec s\u2019occupera du remboursement avec vous.'],
  askRefundDone: ['Asked. The execs can see it \u2014 they\u2019ll be in touch.', 'Demand\u00e9. Les execs le voient \u2014 ils vous contacteront.'],
  refundsBtn: ['Refunds', 'Remboursements'],
  refundsTitle: ['Money to give back', 'Argent \u00e0 rembourser'],
  refundsHint: ['People who paid, then could not come, and gave up their spot. Marking one done records that an exec dealt with it \u2014 it does not move any money.',
                'Des gens qui ont pay\u00e9, puis n\u2019ont pas pu venir et ont lib\u00e9r\u00e9 leur place. Marquer comme fait indique qu\u2019un exec s\u2019en est occup\u00e9 \u2014 cela ne transf\u00e8re aucun argent.'],
  refundsWaiting: ['waiting', 'en attente'],
  refundsOwed: ['to give back', '\u00e0 rembourser'],
  refundsNone: ['Nobody is waiting on a refund.', 'Personne n\u2019attend de remboursement.'],
  refundsDone: ['Refunded', 'Rembours\u00e9'],
  refundsDoneAsk: ['Mark {name}\u2019s {amount} as refunded? Do this once you have actually sent it.',
                   'Marquer les {amount} de {name} comme rembours\u00e9s? \u00c0 faire une fois l\u2019argent r\u00e9ellement envoy\u00e9.'],
  refundsDoneToast: ['{name} is marked as refunded.', '{name} est marqu\u00e9 comme rembours\u00e9.'],
  refundsPaidBack: ['Already refunded ({n})', 'D\u00e9j\u00e0 rembours\u00e9s ({n})'],
  refundsSettledBy: ['by {name}, {when}', 'par {name}, {when}'],
  logRefund: ['Refunded {amount} to {name} for {date}', '{amount} rembours\u00e9s \u00e0 {name} pour le {date}'],
  ...
  signInModeLbl: ['Google / email sign-in', 'Connexion Google / courriel'],
  signInModeOff: ['Off \u2014 use the exec PIN', 'D\u00e9sactiv\u00e9 \u2014 utiliser le NIP'],
  signInModeOptional: ['Offered \u2014 people can sign in if they want', 'Propos\u00e9e \u2014 chacun peut se connecter s\u2019il veut'],
  signInModeRequired: ['Required \u2014 nobody gets in without it', 'Obligatoire \u2014 personne n\u2019entre sans'],
  signInModeHint: ['Leave this off unless the club wants it. Google and email-link sign-in have to be switched on in Firebase first, or the buttons have nothing to talk to.',
                   'Laissez d\u00e9sactiv\u00e9 sauf si le club le souhaite. La connexion Google et par lien courriel doit d\u2019abord \u00eatre activ\u00e9e dans Firebase, sinon les boutons ne m\u00e8nent nulle part.'],
  offerSignInAsk: ['Start offering sign-in? Make sure Google and Email link sign-in are switched on in the Firebase console first \u2014 without them the buttons will just fail.',
                   'Commencer \u00e0 proposer la connexion? Activez d\u2019abord Google et le lien par courriel dans la console Firebase \u2014 sans cela, les boutons \u00e9choueront.'],
  offerSignInGo: ['Offer it', 'La proposer'],
  ...
  orWord: ['or', 'ou'],
  signInEmailLbl: ['No Google account? Use your email', 'Pas de compte Google? Utilisez votre courriel'],
  signInSendLink: ['Email me a sign-in link', 'M\u2019envoyer un lien de connexion'],
  signInLinkNote: ['We send a link \u2014 tap it and you\u2019re in. Nothing to remember.',
                   'Nous envoyons un lien \u2014 touchez-le et c\u2019est fait. Rien \u00e0 retenir.'],
  signInLinkSent: ['Sent to {email}. Open it on this phone to finish.', 'Envoy\u00e9 \u00e0 {email}. Ouvrez-le sur ce t\u00e9l\u00e9phone pour terminer.'],
  signInFailed: ['That didn\u2019t work. Try again, or use the other way in.', '\u00c7a n\u2019a pas fonctionn\u00e9. R\u00e9essayez, ou utilisez l\u2019autre m\u00e9thode.'],
  signOut: ['Sign out', 'D\u00e9connexion'],
  signOutAsk: ['Sign out of CRSC on this phone?', 'Se d\u00e9connecter de CRSC sur ce t\u00e9l\u00e9phone?'],
  execTag: ['EXEC', 'EXEC'],
  policiesLink: ['Club policies and FAQ', 'Politiques du club et FAQ'],
  // The exec list.
  execsBtn: ['Execs', 'Execs'],
  execsTitle: ['Who can make changes', 'Qui peut faire des changements'],
  execsHint: ['Only these addresses get exec powers, and only they can change this list. Everyone else sees the lists and their own spot.',
              'Seules ces adresses ont les pouvoirs d\u2019exec, et elles seules peuvent modifier cette liste. Tous les autres voient les listes et leur propre place.'],
  execsAddLbl: ['Add an exec', 'Ajouter un exec'],
  execsEmpty: ['Nobody is listed \u2014 add yourself first.', 'Personne n\u2019est list\u00e9 \u2014 ajoutez-vous d\u2019abord.'],
  execsYou: ['this is you', 'c\u2019est vous'],
  execsYouChip: ['you', 'vous'],
  execsAdded: ['{email} can now make changes.', '{email} peut maintenant faire des changements.'],
  execsAlready: ['{email} is already an exec.', '{email} est d\u00e9j\u00e0 un exec.'],
  execsDropAsk: ['Remove {email} from the execs? They keep their account and their spots.',
                 'Retirer {email} des execs? Le compte et les places sont conserv\u00e9s.'],
  execsDropped: ['{email} is no longer an exec.', '{email} n\u2019est plus un exec.'],
  execsLastOne: ['Somebody has to be an exec \u2014 add another one first.', 'Il faut au moins un exec \u2014 ajoutez-en un autre d\u2019abord.'],
  logExecs: ['Changed the exec list to {n}: {list}', 'Liste des execs chang\u00e9e \u00e0 {n}\u00a0: {list}'],
  ...
  applySeasonConfirm: ['Copy these lists onto the {n} Saturdays after {date}? Existing lists keep their sign-ups; empty lists that are not here are removed.',
                       'Copier ces listes sur les {n} samedis apr\u00e8s le {date}? Les listes existantes gardent leurs inscriptions; les listes vides absentes d\u2019ici seront retir\u00e9es.'],
  appliedSeason: ['{n} Saturdays updated.', '{n} samedis mis \u00e0 jour.'],
  appliedKept: ['{n} list(s) were left alone because people had already signed up for them.',
                '{n} liste(s) ont \u00e9t\u00e9 laiss\u00e9es telles quelles, car des gens y \u00e9taient d\u00e9j\u00e0 inscrits.'],
  nothingLater: ['There is no later Saturday to copy onto.', 'Aucun samedi ult\u00e9rieur o\u00f9 copier.'],
  duplicateEvent: ['Duplicate to another date', 'Dupliquer \u00e0 une autre date'],
  duplicateAsk: ['Copy this Saturday to which date?', 'Copier ce samedi \u00e0 quelle date?'],
  duplicated: ['Copied to {date}.', 'Copi\u00e9 au {date}.'],
  dateTaken: ['There is already an event on {date}.', 'Un \u00e9v\u00e9nement existe d\u00e9j\u00e0 le {date}.'],
