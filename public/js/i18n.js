...
const STRINGS = {
  ...
  openSeasonPick: ['Every Saturday up to {end} that does not exist yet. Untick the weeks the club is off \u2014 the break between seasons, a long weekend.',
                   'Tous les samedis jusqu\u2019au {end} qui n\u2019existent pas encore. D\u00e9cochez les semaines de rel\u00e2che \u2014 la pause entre les saisons, un long week-end.'],
  createThem: ['Create them', 'Les cr\u00e9er'],
  deleteThisSaturday: ['Delete this Saturday', 'Supprimer ce samedi'],
  deleteSaturdayAsk: ['Delete {date}? {n} sign-up(s) and {held} held spot(s) go with it. This cannot be undone.',
                      'Supprimer le {date}? {n} inscription(s) et {held} place(s) r\u00e9serv\u00e9e(s) dispara\u00eetront. Irr\u00e9versible.'],
  logEventDeleted: ['Deleted the Saturday of {date} and its {n} sign-up(s)', 'Samedi du {date} supprim\u00e9, avec ses {n} inscription(s)'],
